...
public static class RPNConsts
{
  ...
  public static readonly Dictionary<FormulaElementType, int[]> Precedence = new Dictionary<FormulaElementType, int[]> {
        ...
        {FormulaElementType.SET, new int[] { -5, LEFT_ASSOC }},
        {FormulaElementType.INCREMENT, new int[] { -5, LEFT_ASSOC }},
        {FormulaElementType.DECREMENT, new int[] { -5, LEFT_ASSOC }},
        ...
        {FormulaElementType.MIN, new int[] { 0, LEFT_ASSOC }},
        {FormulaElementType.MAX, new int[] { 0, LEFT_ASSOC }},
        ...
        {FormulaElementType.LOGICALAND, new int[] { 2, LEFT_ASSOC }},
        {FormulaElementType.LOGICALOR, new int[] { 1, LEFT_ASSOC }},
        {FormulaElementType.BITWISEAND, new int[] { 4, LEFT_ASSOC }},
        {FormulaElementType.BITWISEOR, new int[] { 3, LEFT_ASSOC }},
